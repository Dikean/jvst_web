...
function TableFacturacion() {
  return (
    <>
             
             {/* <>
             <!-- component --> */}
<section class=" mb-5 container px-4 mx-auto mb-5 ">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">PDF</th>
