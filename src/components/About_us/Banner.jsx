import ImgBanner from '../../assets/img/About_us_count.png'
function Banner() {
    return (
     <>
<section class="py-8 lg:px-[120px] mb-5">
      ...
      <div class="flex flex-wrap">
        <div class="w-full md:w-1/2 pt-6 mb-10 md:mb-0">
          <h3 class="mb-1 text-2xl font-bold text-white">
            <span>A jesucristo</span>
            <span class="text-green-300"> ven sin tardar</span>
          </h3>
          <p class="mb-8 md:mb-16 text-sm font-medium text-indigo-100">No charge for seven days</p>
          <a class="flex items-center text-white font-medium" href="/Register">
        ...
        <div class="w-full md:w-1/2 flex items-center">
          <img class="mx-auto h-60" src={ImgBanner} alt=""/>
        </div>
      </div>
    </div>
  </div>
